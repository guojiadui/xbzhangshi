...
import com.xbzhangshi.mvp.record.adapter.SBSportsDetailsAdapter;
...
public class SBSportsRecordDetailsActivity extends BaseActivity {
    ...
    public static void start(Context context, SBSportsRecordBean.RowsBean listBean) {

        if ("BBIN".equals(listBean.getPlatformType())) {
            return;
        }
        Intent intent = new Intent(context, SBSportsRecordDetailsActivity.class);
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        listBean = (SBSportsRecordBean.RowsBean) getIntent().getSerializableExtra("obj");
        ...
        if (listBean != null) {
            ...
            recyclerView.setAdapter(new SBSportsDetailsAdapter(this, listBean));
        }
    }
