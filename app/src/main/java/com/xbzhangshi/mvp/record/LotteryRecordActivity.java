...
public class LotteryRecordActivity extends BaseActivity implements ILotteryBaseView, OnLoadMoreListener {
    ...
    public void initsearch(List<LotteryRecordBean.ContentBean> contentBeans) {
        ...
        lotteryType.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, list1));
        ...
        list2.add("未中奖");
        list2.add("撤单");
        lotteryState.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, list2));
