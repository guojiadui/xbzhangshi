 ...
 * 棋牌
 */
public class CardGameActivity extends BaseWebViewActivity {

    public static long startitme = 0;

    public static void start(Context context, String code,String gameId) {
        ...
        Intent intent = new Intent(context, CardGameActivity.class);
    ...
    public void getUrl() {
        ...
        HttpManager.getObject(this, TransUrlBean.class, Url.forwardReal + code+"&gameId="+gameId, null, new OkGoCallback<TransUrlBean>() {
            @Override
            public void onSuccess(TransUrlBean response) {
                ...
                if (response.isSuccess()) {
                    ...
                    if (!TextUtils.isEmpty(response.getMsg())) {
                        Toast.makeText(CardGameActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
