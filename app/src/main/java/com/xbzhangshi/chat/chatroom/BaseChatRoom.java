...
import com.xbzhangshi.chat.bean.ObserverModel;
import com.xbzhangshi.chat.listener.IChatRoom;
import com.xbzhangshi.chat.listener.IConstants;
import com.xbzhangshi.chat.listener.IEventType;
...
/**
 * 实现listener 监听socketd的事件，同时是作为Observable把监听的事件整理通知被观察者
 */
