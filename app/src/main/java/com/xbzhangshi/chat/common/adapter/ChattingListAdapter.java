...
import com.xbzhangshi.chat.common.utils.ImageLoadUtils;
        ...
        switch (type) {
            case VIEW_TYPE_LEFT_TEXT:
                ...
                if (convertView == null) {
                    ...
                    holderView = mInflater.inflate(R.layout.chat_listitem_cha_left_text, null);
            ...
            case VIEW_TYPE_LEFT_IMAGE:
                ...
                if (convertView == null) {
                    ...
                    holderView = mInflater.inflate(R.layout.chat_listitem_chat_left_image, null);
                    holderView.setFocusable(true);
