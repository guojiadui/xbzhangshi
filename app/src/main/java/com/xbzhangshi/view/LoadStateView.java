...
public class LoadStateView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.LoadSTateView_loadingProgressBarWidth, 250);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.LoadSTateView_loadingProgressBarHeight, 250);
