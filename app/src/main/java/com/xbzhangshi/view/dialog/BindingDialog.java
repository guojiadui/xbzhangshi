...
public class BindingDialog extends Dialog {
    Context context;
    public BindingDialog(@NonNull Context context,String title,String contentTip,ClickListener clickListener) {
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.banding_dialog_layout, null);
        setContentView(view);
