...
public class FileUtils {
    ...
    public static String createPicturePath(Context context) {
        ...
        if (isSdCardAvailable()) {
            ...
            picturePath = context.getExternalFilesDir(Environment.DIRECTORY_PICTURES).getPath();
        } else {
            // /data/data/<application package>/files
            picturePath = context.getFilesDir().getPath();
        }
        return picturePath;
    }
    ...
    public static String createDownLoadPath(Context context) {
        ...
        if (isSdCardAvailable()) {
            ...
            cacheRootPath = context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getPath();
        } else {
            // /data/data/<application package>/files
    ...
    public static String getImageCachePath(Context context) {
        String path = createDir(createPicturePath(context) + File.separator + "img" + File.separator);
        return path;
    }
    ...
    public static String getImageCropCachePath(Context context) {
        String path = createDir(createPicturePath(context) + File.separator + "imgCrop" + File.separator);
        return path;
    }
